...
def get_parser():
    ...
    parser.add_argument('--num_dimension', type=int, default=30)
    ...
    parser.add_argument('--label_compress', type=bool, default=True)
    parser.add_argument('--consistency_loss', type=bool, default=True)
    parser.add_argument('--visualize_sc', type=bool, default=True)
    parser.add_argument('--num_critic', type=int, default=1)
    parser.add_argument('--lambda_gp', type=int, default=10)
    parser.add_argument('--lambda_class', type=int, default=5)
