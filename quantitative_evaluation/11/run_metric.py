...
def main():
    ...
    if CONFIG.GAN_train:
        ...
        GAN_train_score, AP_train_earch_imp = calc_GAN_train(real_img/2 + 0.5, fake_img/2 + 0.5,  ID, label, label_selected)
    ...
    if CONFIG.GAN_test:
        ...
        GAN_test_score, AP_test_earch_imp = calc_GAN_test(real_img/2 + 0.5, fake_img/2 + 0.5,  ID, label, label_selected)
